...
while ($row = mysqli_fetch_assoc($datos)) {
    ...
    $tabla["data"][] = [
        ...
        "acciones" => "<button class='btn btn-sm btn-info' onclick='editar_datos_filial(true, `" . $id . "`, `" . $nombre . "`, `" . $departamento . "`);'>✎</button>
        <button class='btn btn-sm btn-danger' onclick='confirmar_eliminar_filial(`" . $id . "`);'>❌</button>",
    ];
}
