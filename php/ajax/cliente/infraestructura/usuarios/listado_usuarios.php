...
while ($row = mysqli_fetch_assoc($datos)) {
    ...
    $tabla["data"][] = [
        ...
        "acciones" => "<button class='btn btn-sm btn-info' onclick='editar_datos_usuario(true, `" . $id . "`, `" . $usuario . "`, `" . $nombre . "`, `" . $apellido . "`, `" . $id_area . "`, `" . $area . "`, `" . $id_departamento . "`, `" . $departamento . "`);'>✎</button>
        <button class='btn btn-sm btn-danger' onclick='confirmar_eliminar_usuario(`" . $id . "`);'>❌</button>",
    ];
}
